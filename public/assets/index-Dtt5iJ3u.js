...
const BUILD = /* main */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, asyncQueue: false, attachStyles: true, cloneNodeFix: false, constructableCSS: true, cssAnnotations: true, deserializer: false, devTools: false, element: false, event: true, experimentalScopedSlotChanges: false, experimentalSlotFixes: false, formAssociated: false, hasRenderFn: true, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: false, hydrateClientSide: false, hydrateServerSide: false, hydratedAttribute: false, hydratedClass: true, hydratedSelectorName: "hydrated", initializeNextTick: false, invisiblePrehydration: true, isDebug: false, isDev: false, isTesting: false, lazyLoad: true, lifecycle: false, lifecycleDOMEvents: false, member: true, method: false, mode: false, observeAttribute: true, profile: false, prop: true, propBoolean: true, propChangeCallback: true, propMutable: false, propNumber: true, propString: true, reflect: true, scoped: false, scopedSlotTextContentFix: false, scriptDataOpts: false, serializer: false, shadowDelegatesFocus: false, shadowDom: true, shadowSlotAssignmentManual: false, slot: true, slotChildNodesFix: false, slotRelocation: true, state: true, style: true, svg: false, taskQueue: true, transformTagName: false, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: true, vdomKey: true, vdomListener: true, vdomPropOrAttr: true, vdomRef: false, vdomRender: true, vdomStyle: true, vdomText: true, vdomXlink: false };
const Env = /* main */ {};

const globalScripts = () => {};
const globalStyles = ":root{--dl-bg-primary:#1a1a2e;--dl-bg-secondary:#16213e;--dl-bg-tooltip:#0f0f1a;--dl-text-primary:#e0e0e0;--dl-text-secondary:#a0a0b0;--dl-text-muted:#6a6a7a;--dl-text-tooltip:#f7e7d1;--dl-border:#2a2a4a;--dl-weapon:#cc8932;--dl-vitality:#6dc04b;--dl-spirit:#c878f0;--dl-tier-1:#8b9bae;--dl-tier-2:#5a9e3e;--dl-tier-3:#c076db;--dl-tier-4:#e08b35;--dl-tier-5:#e04545;--dl-font-family:'Retail Demo', sans-serif;--dl-radius:4px;--dl-transition:150ms ease}";
...
export { BUILD as B, H, NAMESPACE as N, StencilCore as S, createEvent as a, bootstrapLazy as b, consoleDevInfo as c, getElement as d, globalScripts as g, h, promiseResolve as p, registerInstance as r, setNonce as s, win as w };
